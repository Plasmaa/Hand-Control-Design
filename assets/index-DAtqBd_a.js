...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Qd(i,e,t){const n=new Float32Array(fi),r=new ee(0,1,0);return new Vn({name:"SphericalGaussianBlur",defines:{n:fi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function ko(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Wo(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ss(),fragmentShader:`
...
`)+`
`+p);const D=I+_+o,L=I+p+c,G=Jo(r,r.VERTEX_SHADER,D),U=Jo(r,r.FRAGMENT_SHADER,L);r.attachShader(T,G),r.attachShader(T,U),t.index0AttributeName!==void 0?r.bindAttribLocation(T,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(T,0,"position"),r.linkProgram(T);function B(E){if(i.debug.checkShaderErrors){const V=r.getProgramInfoLog(T)||"",k=r.getShaderInfoLog(G)||"",J=r.getShaderInfoLog(U)||"",Q=V.trim(),z=k.trim(),$=J.trim();let Y=!0,se=!0;if(r.getProgramParameter(T,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,T,G,U);else{const fe=ec(r,G,"vertex"),De=ec(r,U,"fragment");Rt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(T,r.VALIDATE_STATUS)+`
